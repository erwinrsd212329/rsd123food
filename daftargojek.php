...
echo color("green","[]          RSD123 by GLD              \n");
echo color("yellow","[]       TES JANDA KEMBANG             \n");
echo color("green","[]  Time  : ".date('[d-m-Y] [H:i:s]')."   \n");
echo color("yellow","[]         waiting proses.....           \n");
echo color("yellow","[] cara menulis nomor lur pakai 62xxxxxxxxxx \n");
function change(){
        $nama = nama();
        ...
        sleep(3);
        $boba11 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOFOOD021120B"}');
        ...
        sleep(3);
        $cekvoucher = request('/gopoints/v3/wal
let/vouchers?limit=10&page=1', $token);
